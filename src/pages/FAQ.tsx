    ...
    <main className="flex h-screen text-center bg-deepPurple ">
      <div className="m-auto space-y-3 flex flex-col">
        ...
        <text className={"text-superCoolEdgyPurple "}>
          ...
          Its&apos basically an edgier looking pastebin
        </text>

        <h1 className={"text-contrastingBlue"}>What data do you keep?</h1>
        <text className={"text-superCoolEdgyPurple "}>
          Since all authentication is done via Oauth providers (Discord, Google, Etc) <span className={"text-red-400"}>I do not see, or store any passwords </span>
          <br />
        ...
        <text className={"text-superCoolEdgyPurple "}>
          Pastes are `unlisted` by default, that is, anyone who doesn&apost have the URL cannot view it. <br />
        ...
        <text className={"text-superCoolEdgyPurple "}>
          No, I can&apost find a way to store images for cheap, if you know how let me know <br />
          I highly recommend <a href={"https://upload.systems"}
                                className={"underline text-green-400"}>upload.systems</a> if you want image hosting,
          they&aposre pretty cool
        </text>

        <h1 className={"text-contrastingBlue"}>Is the site open source?</h1>
        <text className={"text-superCoolEdgyPurple "}>
          <a className={"cursor-pointer text-green-400 underline"} href={"https://github.com/0x978/textUploader"}>Yea
            click here</a>
        </text>
        ...
        <div>
          <button className={"bg-puddlePurple text-green-400 w-32 "} onClick={() => void router.push("/")}>Return
          </button>
        </div>
